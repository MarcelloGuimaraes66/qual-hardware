# Memória — catálogo de componentes e benchmarks v4

- Branch local: `archon/definitive-component-evidence-v4`, base `7bcc103`.
- Archon estava sem créditos; o fluxo T4 equivalente foi documentado manualmente.
- SQLite atual: v7, estritamente aditivo.
- Contrato de workload atual: `perceptrum-workload/3.1.0`.
