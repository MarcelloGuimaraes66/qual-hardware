...
- The PDF keeps the complete original commercial report as Part I, with alternatives and all six blocks of every proposal, before starting the numbered detailed specifications in Part II. Internal audit stays in XLSX/JSON and neutral requirements stay in their separate annex. Brazilian Portuguese, justified explanatory paragraphs, visual review and searchable-text extraction are required.
