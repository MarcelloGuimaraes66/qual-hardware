...
const targets = [
  ...
  { format: "technical-pdf", path: resolve(pdfDirectory, "qual-hardware-caderno-tecnico-detalhado.pdf") },
  { format: "technical-docx", path: resolve(documentDirectory, "qual-hardware-caderno-tecnico-detalhado.docx") },
