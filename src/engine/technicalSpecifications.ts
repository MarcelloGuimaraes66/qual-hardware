...
const PROFILE_FIELDS: Partial<Record<HardwareComponentKind, FieldDefinition[]>> = {
  cpu: [
    ...
    field("low_power_efficient_cores", "Núcleos de eficiência de baixo consumo (LP E-cores)", "number", "núcleos", false, roles("dimensioning", "informational"), ["low power efficient cores", "lp e-core count"]),
    ...
    field("low_power_efficient_core_base_clock_ghz", "Frequência base dos LP E-cores", "number", "GHz", false, roles("dimensioning", "informational"), ["low power efficient-core base frequency", "lp e-core base frequency"]),
    field("low_power_efficient_core_max_clock_ghz", "Frequência turbo dos LP E-cores", "number", "GHz", false, roles("dimensioning", "informational"), ["low power efficient-core max turbo frequency", "lp e-core max turbo frequency"]),
    ...
    field("compute_tile_process", "Processo de fabricação do Compute Tile", "string", null, false, roles("informational"), ["compute tile process"]),
    field("soc_tile_process", "Processo de fabricação do SoC Tile", "string", null, false, roles("informational"), ["soc tile process"]),
    field("graphics_tile_process", "Processo de fabricação do Graphics Tile", "string", null, false, roles("informational"), ["graphics tile process"]),
    field("die_size_mm2", "Área do silício", "number", "mm²", false, roles("informational"), ["die size"]),
    field("transistor_count_billion", "Quantidade de transistores", "number", "bilhões", false, roles("informational"), ["transistor count"]),
    ...
    field("hardware_scheduler", "Agendador de hardware", "string", null, false, roles("compatibility", "informational"), ["thread director", "hardware scheduler"]),
    ...
    field("supported_operating_systems", "Sistemas operacionais suportados", "string", null, false, roles("compatibility", "procurement"), ["operatingSystems", "os support"], "operatingSystems"),
  ],
  gpu: [
    ...
    field("cuda_cores", "Núcleos CUDA", "number", "núcleos", false, roles("dimensioning", "informational"), ["cuda cores"]),
    field("stream_processors", "Processadores de fluxo", "number", "unidades", false, roles("dimensioning", "informational"), ["stream processors"]),
    field("vram_gb", "Memória de vídeo", "number", "GB", true, roles("dimensioning", "procurement"), ["vramGb", "memoryGb"]),
    field("memory_type", "Tipo de memória de vídeo", "string", null, true, roles("dimensioning", "procurement"), ["vramType"]),
    field("memory_bus_bits", "Barramento de memória", "number", "bits", false, roles("dimensioning", "procurement"), ["memoryBusBits"]),
    ...
    field("video_encode_engines", "Quantidade e geração dos codificadores de vídeo", "string", null, false, roles("dimensioning", "informational"), ["nvenc engines"]),
    field("video_decode_engines", "Quantidade e geração dos decodificadores de vídeo", "string", null, false, roles("dimensioning", "informational"), ["nvdec engines"]),
    field("pcie_generation", "Geração PCI Express", "number", null, true, roles("compatibility", "procurement"), [], "pcieGeneration"),
    field("continuous_power_watts", "Potência gráfica", "number", "W", true, roles("compatibility", "procurement"), ["tbpWatts", "tdpWatts"], "continuousPowerWatts"),
    field("required_system_power_watts", "Potência recomendada para o sistema", "number", "W", false, roles("compatibility", "procurement"), ["required system power"]),
    field("maximum_temperature_c", "Temperatura máxima de operação da GPU", "number", "°C", false, roles("compatibility", "procurement"), ["maximum gpu temperature"]),
    field("power_connectors", "Conectores de alimentação", "string", null, true, roles("compatibility", "procurement"), ["powerConnectors"]),
    ...
    field("video_decode", "Codecs de decodificação", "string", null, true, roles("compatibility", "dimensioning", "procurement"), ["decodeCodecs", "supportedCodecs"]),
    field("video_encode", "Codecs de codificação", "string", null, true, roles("compatibility", "dimensioning", "procurement"), ["encodeCodecs"]),
    field("acceleration_backends", "Backends de aceleração", "string", null, true, roles("compatibility", "procurement"), ["backends"], "accelerationBackends"),
    field("graphics_apis", "APIs gráficas e computacionais", "string", null, false, roles("compatibility", "informational"), ["graphics apis", "api support"]),
    field("multi_gpu_support", "Suporte a múltiplas GPUs", "string", null, false, roles("compatibility", "procurement"), ["multi gpu support"]),
    field("driver_branch", "Família de drivers", "string", null, false, roles("compatibility", "procurement"), ["driver branch"]),
  ...
  motherboard: [
    ...
    field("minimum_bios", "Versão mínima de BIOS", "string", null, false, roles("compatibility", "procurement"), [], "minimumBios"),
    field("form_factor", "Formato", "string", null, true, roles("compatibility", "procurement"), ["formFactor"]),
    field("memory_type", "Tipo de memória", "string", null, true, roles("compatibility", "procurement"), [], "memoryType"),
    field("memory_slots", "Slots de memória", "number", "slots", true, roles("compatibility", "procurement"), ["memorySlots"]),
    field("maximum_memory_gb", "Memória máxima", "number", "GB", true, roles("compatibility", "procurement"), [], "maximumMemoryGb"),
    field("ecc_support", "Suporte a ECC", "boolean", null, true, roles("compatibility", "procurement"), [], "ecc"),
    field("pcie_generation", "Geração PCI Express", "number", null, true, roles("compatibility", "procurement"), [], "pcieGeneration"),
    field("pcie_slots", "Slots PCI Express", "string", null, true, roles("compatibility", "procurement"), ["pcieSlots"]),
    field("pcie_bifurcation", "Bifurcação PCI Express", "string", null, false, roles("compatibility"), ["pcieBifurcation"]),
    ...
    field("tpm", "Módulo de plataforma confiável", "string", null, false, roles("procurement"), ["tpm"]),
  ],
  memory_kit: [
    field("capacity_gb", "Capacidade total", "number", "GB", true, roles("dimensioning", "procurement"), ["capacityGb"]),
    field("module_count", "Quantidade de módulos", "number", "módulos", true, roles("compatibility", "procurement"), ["modules"]),
    field("memory_type", "Tecnologia", "string", null, true, roles("compatibility", "procurement"), ["type"], "memoryType"),
    field("speed_mtps", "Taxa de transferência", "number", "MT/s", true, roles("dimensioning", "procurement"), ["speedMtps"]),
    field("ecc", "Correção de erros ECC", "boolean", null, true, roles("compatibility", "procurement"), [], "ecc"),
    field("module_format", "Formato do módulo", "string", null, true, roles("compatibility", "procurement"), ["dimmType"]),
    field("rank", "Organização de ranks", "string", null, false, roles("compatibility"), ["ranks"]),
    field("cas_latency", "Latência CAS", "number", "ciclos", false, roles("dimensioning", "procurement"), ["casLatency"]),
    field("voltage", "Tensão", "number", "V", false, roles("compatibility", "procurement"), ["voltage"]),
  ],
  storage_os: [],
  storage_retention: [],
  nic: [
    ...
    field("media", "Meio físico", "string", null, true, roles("compatibility", "procurement"), ["mediaType"]),
    ...
    field("maximum_mtu", "MTU máximo", "number", "bytes", false, roles("compatibility", "procurement"), ["maximumMtu"]),
    field("rdma", "Suporte a RDMA", "boolean", null, false, roles("compatibility", "procurement"), ["rdma"]),
    field("queue_count", "Quantidade de filas", "number", "filas", false, roles("dimensioning", "informational"), ["queues", "queue count"]),
    field("sriov", "Suporte a SR-IOV", "boolean", null, false, roles("compatibility", "procurement"), ["sr-iov", "sriov"]),
    field("supported_operating_systems", "Sistemas operacionais suportados", "string", null, true, roles("compatibility", "procurement"), ["operatingSystems"], "operatingSystems"),
  ],
  psu: [
    field("continuous_power_watts", "Potência contínua", "number", "W", true, roles("compatibility", "procurement"), ["powerWatts"], "continuousPowerWatts"),
    field("efficiency_rating", "Certificação de eficiência", "string", null, true, roles("procurement"), ["efficiency"]),
    ...
    field("transient_power_watts", "Capacidade transitória", "number", "W", false, roles("compatibility", "procurement"), [], "transientPowerWatts"),
    field("atx_version", "Versão da especificação ATX", "string", null, false, roles("compatibility", "procurement"), ["atxVersion"]),
    field("protections", "Proteções elétricas", "string", null, true, roles("procurement"), ["protections"]),
    field("rails", "Trilhos e limites de corrente", "string", null, false, roles("compatibility", "informational"), ["rails", "12v rail"]),
    field("fan", "Ventoinha da fonte", "string", null, false, roles("informational", "procurement"), ["fan"]),
    field("dimensions_mm", "Dimensões", "string", "mm", false, roles("compatibility", "procurement"), ["dimensions"]),
  ],
  cooling: [
    field("cooling_type", "Tipo de refrigeração", "string", null, true, roles("compatibility", "procurement"), ["type"]),
    field("supported_sockets", "Soquetes suportados", "string", null, true, roles("compatibility", "procurement"), ["sockets"]),
    field("cooling_capacity_watts", "Capacidade térmica declarada", "number", "W", true, roles("compatibility", "procurement"), ["tdpWatts"], "coolingCapacityWatts"),
    field("airflow_cfm", "Fluxo de ar", "number", "CFM", false, roles("dimensioning", "procurement"), ["airflowCfm"]),
    field("noise_dba", "Ruído máximo", "number", "dBA", false, roles("procurement"), ["noiseDba"]),
    field("dimensions_mm", "Dimensões", "string", "mm", true, roles("compatibility", "procurement"), ["dimensions"]),
    field("fan_specification", "Especificação das ventoinhas", "string", null, false, roles("dimensioning", "informational"), ["fan specification", "fans"]),
    field("pump_specification", "Especificação da bomba", "string", null, false, roles("dimensioning", "informational"), ["pump specification", "pump"]),
    field("radiator_dimensions_mm", "Dimensões do radiador", "string", "mm", false, roles("compatibility", "procurement"), ["radiator dimensions"]),
  ],
  chassis: [
    field("form_factor", "Formato do chassi", "string", null, true, roles("compatibility", "procurement"), ["formFactor"]),
    field("supported_motherboards", "Formatos de placa-mãe", "string", null, true, roles("compatibility", "procurement"), ["motherboardSupport"]),
    field("maximum_gpu_length_mm", "Comprimento máximo de GPU", "number", "mm", true, roles("compatibility", "procurement"), ["maxGpuLengthMm"]),
    field("maximum_gpu_slots", "Espessura máxima de GPU", "number", "slots", true, roles("compatibility", "procurement"), ["maxGpuSlots"]),
    field("drive_bays", "Baias de armazenamento", "string", null, true, roles("compatibility", "procurement"), ["driveBays"]),
    field("expansion_slots", "Slots de expansão", "number", "slots", true, roles("compatibility", "procurement"), ["expansionSlots"]),
    ...
    field("dimensions_mm", "Dimensões externas", "string", "mm", true, roles("compatibility", "procurement"), ["dimensions"]),
    field("rack_units", "Unidades de rack", "number", "U", false, roles("compatibility", "procurement"), ["rackUnits"]),
    field("physical_security", "Recursos de segurança física", "string", null, false, roles("procurement", "informational"), ["physical security", "lock"]),
  ],
  oem_system: [
    field("exact_bom", "Configuração exata de fábrica", "string", null, true, roles("compatibility", "procurement"), ["bom"]),
    field("expansion", "Capacidade de expansão", "string", null, true, roles("compatibility", "procurement"), ["expansion"]),
    field("redundancy", "Recursos de redundância", "string", null, false, roles("procurement"), ["redundancy"]),
    ...
    field("maximum_power_watts", "Potência máxima", "number", "W", true, roles("compatibility", "procurement"), ["powerWatts"]),
    field("dimensions_mm", "Dimensões", "string", "mm", true, roles("compatibility", "procurement"), ["dimensions"]),
    field("support_years", "Suporte do fabricante", "number", "anos", true, roles("procurement", "informational"), ["supportYears"]),
    field("certifications", "Certificações", "string", null, false, roles("procurement"), ["certifications"]),
    field("rail_kit", "Kit de trilhos", "string", null, false, roles("compatibility", "procurement"), ["rail kit"]),
    field("firmware_support", "Política de firmware e atualização", "string", null, false, roles("compatibility", "procurement"), ["firmware support"]),
  ],
  rack_configuration: [
    field("rack_units", "Unidades de rack", "number", "U", true, roles("compatibility", "procurement"), ["rackUnits"]),
    field("node_count", "Quantidade de nós", "number", "nós", true, roles("dimensioning", "procurement"), ["nodeCount"]),
    field("power_redundancy", "Redundância de energia", "string", null, true, roles("procurement"), ["powerRedundancy"]),
    field("network_redundancy", "Redundância de rede", "string", null, true, roles("procurement"), ["networkRedundancy"]),
  ],
};
...
const storageFields: FieldDefinition[] = [
  ...
  field("random_read_iops", "Leitura aleatória", "number", "IOPS", true, roles("dimensioning", "procurement"), ["randomReadIops"]),
  field("random_write_iops", "Escrita aleatória", "number", "IOPS", true, roles("dimensioning", "procurement"), ["randomWriteIops"]),
  field("latency_us", "Latência declarada", "number", "µs", false, roles("dimensioning", "procurement"), ["latencyUs"]),
  field("endurance_tbw", "Endurance", "number", "TBW", true, roles("dimensioning", "procurement"), ["tbw"]),
  field("endurance_dwpd", "Gravações completas por dia", "number", "DWPD", false, roles("dimensioning", "procurement"), ["dwpd"]),
  field("power_loss_protection", "Proteção contra perda de energia", "boolean", null, false, roles("procurement"), ["plp"]),
  field("hardware_encryption", "Criptografia por hardware", "string", null, false, roles("procurement"), ["encryption"]),
  field("controller", "Controlador", "string", null, false, roles("dimensioning", "informational"), ["controller"]),
  field("nand_type", "Tipo de memória NAND", "string", null, false, roles("dimensioning", "informational"), ["nand", "nand type"]),
  field("dram_cache", "Cache DRAM", "string", null, false, roles("dimensioning", "informational"), ["dram cache", "cache"]),
  field("active_power_watts", "Consumo ativo", "number", "W", false, roles("compatibility", "informational"), ["active power"]),
];
...
function completeness(fields: TechnicalSpecificationField[]): ComponentSpecificationCompleteness {
  ...
  const reasons = [
    ...(missingRequiredFieldCodes.length ? [`Campos oficiais obrigatórios ausentes: ${missingRequiredFieldCodes.join(", ")}.`] : []),
